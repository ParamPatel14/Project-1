  ...
  return (
    <div className="max-w-7xl mx-auto mt-8 px-4 pb-12">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 border-b border-stone-200 pb-6">
        <div>
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-[var(--color-academia-charcoal)] mb-2">
            Academic Opportunities
          </h2>
          <p className="text-stone-500 max-w-xl text-base md:text-lg font-light">
        ...
        <div className="mt-6 md:mt-0 flex items-center gap-3 w-full md:w-auto">
          <div className="relative w-full md:w-auto">
            ...
            <select
              ...
              className="w-full md:w-auto pl-10 pr-8 py-2.5 bg-white border border-stone-300 rounded-sm focus:outline-none focus:ring-1 focus:ring-[var(--color-academia-gold)] focus:border-[var(--color-academia-gold)] shadow-sm font-serif text-[var(--color-academia-charcoal)] appearance-none min-w-[200px]"
            >
