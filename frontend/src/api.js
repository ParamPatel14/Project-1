...
// Industrial & Beehive APIs
export const submitProjectInterest = async (data) => {
  const response = await api.post("/industrial/interest", data);
  return response.data;
};

export const getProjectInterests = async (studentId = null) => {
  const params = studentId ? `?student_id=${studentId}` : "";
  const response = await api.get(`/industrial/interest${params}`);
  return response.data;
};

export const createIndustrialVisit = async (data) => {
  const response = await api.post("/industrial/visits", data);
  return response.data;
};

export const getIndustrialVisits = async () => {
  const response = await api.get("/industrial/visits");
  return response.data;
};

export const applyForVisit = async (visitId, data) => {
  const response = await api.post(`/industrial/visits/${visitId}/apply`, data);
  return response.data;
};

export const getVisitApplications = async (visitId) => {
  const response = await api.get(`/industrial/visits/${visitId}/applications`);
  return response.data;
};

export const updateVisitApplicationStatus = async (applicationId, status) => {
  const response = await api.put(`/industrial/applications/${applicationId}/status`, { status });
  return response.data;
};

export const createBeehiveEvent = async (data) => {
  const response = await api.post("/beehive/events", data);
  return response.data;
};

export const getBeehiveEvents = async () => {
  const response = await api.get("/beehive/events");
  return response.data;
};

export const enrollBeehiveEvent = async (eventId, data) => {
  const response = await api.post(`/beehive/events/${eventId}/enroll`, data);
  return response.data;
};

export const getBeehiveEnrollments = async (eventId) => {
  const response = await api.get(`/beehive/events/${eventId}/enrollments`);
  return response.data;
};
